...
해당 소스파일 정보: 게시글 삭제 폼 관리자버전.
			 ...
			 관리자 비밀번호를 입력 후 '게시글 삭제'버튼을 클릭하면 실제로 삭제 과정을 진행하는 Q&ARemoveActionManager.jsp로 이동함.
 -->
...
%>
    <form action="<%=request.getContextPath()%>/Yerin/Q&ARemoveActionManager.jsp" method="post">
