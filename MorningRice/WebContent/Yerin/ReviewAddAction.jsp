...
try {
    ...
    String sql = "INSERT INTO review_board(board_pw, board_title, board_content, board_user, board_date) values(?,?,?,?,now())";
  ...
  response.sendRedirect(request.getContextPath()+"/Yerin/ReviewList.jsp"); //게시글 등록후 게시글 목록으로 이동
} catch(Exception e) {
    e.printStackTrace();
