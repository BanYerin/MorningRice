...
해당 소스파일 정보: 게시글 수정 폼.
			 ...
			 게시글 수정 후 '글 수정'버튼을 클릭하면 실제로 수정 과정을 진행하는 ReviewModiftAction.jsp로 이동함.
 -->
...
if(request.getParameter("boardNo") == null) {//게시글번호가 null인 경우
    ...
    try {
        ...
        String selectSql = "SELECT board_title, board_content, board_user FROM review_board WHERE board_no=?";
...
%>    
    <div align="center">
	<h1>이용후기 수정</h1>
    <form action="<%=request.getContextPath()%>/Yerin/ReviewModifyAction.jsp" method="post">
