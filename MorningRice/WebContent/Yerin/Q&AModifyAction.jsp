...
if(request.getParameter("boardNo") == null || request.getParameter("boardPw") == null ) {//게시글번호가 null이거나 게시글 수정폼에 입력받은 비밀번호가 null일 경우
    ...
    try {
        ...
        System.out.println("DB연결완료");
            ...
            String selectSql = "UPDATE qa_board SET board_title=?, board_content=? WHERE board_no=? AND board_pw=?";
            ...
            response.sendRedirect(request.getContextPath()+"/Yerin/Q&AView.jsp?boardNo="+boardNo);
