...
해당 소스파일 정보: 게시글 작성 폼.
			  ...
			  게시글 작성 후 '등록'버튼을 클릭하면 실제로 등록과정을 진행하는 Q&AAddAction.jsp로 이동함.
 -->
...
<p>모닝라이스에 대해 궁금하신 점을 모두 물어보세요! 글에 연락처를 남겨주시면 답변을 보내드립니다!:)</p>
<form action="<%=request.getContextPath()%>/Yerin/Q&AAddAction.jsp" method="post">
